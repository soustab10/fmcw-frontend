export const Data = [
  {
    ...
    answer:
      '9th to 11th April, 2021. But you can start participating right now by registering.',
  },
  {
  ...
  {
    question:
      'Is it possible to attend another genres workshop while participating in one event?',
    answer:
      'No, for example, if you participate in one of the photography clubs events, then you cannot attend a workshop of the design club. However, buying the All workshop pass allows you to participate in any and all workshops and the All Fest pass allows you to participate in any and all events and workshops.',
  },

  {
    question: 'Who will be taking the workshop?',
    answer:
      'The details of the workshops can be checked on the website and the instagram page(@fmc_weekend) , so dont hold back and get your passes soon.',
  },
  {
    question:
      'Is the submission of previously clicked,written or made entries acceptable?',
    answer:
